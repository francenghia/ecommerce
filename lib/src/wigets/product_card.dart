        ...
        child: Stack(
          ...
          children: <Widget>[
            Positioned(
              ...
              top: 0,
              child: IconButton(
                icon: Icon(model.isliked ? Icons.favorite : Icons.favorite_border, color: model.isliked ? ColorsLight.red : ColorsLight.iconColor,),
                 onPressed: (){
                   setState(() {
              ...
              children: <Widget>[
                ...
                Stack(
                  ...
                  children: <Widget>[
                    CircleAvatar(
                      radius: 40,
                      backgroundColor: ColorsLight.orange.withAlpha(40),
                    ),
